...
STAT_GROUPS = (
    ...
    (
        "攻击",
        (
            ("base_weapon_damage", "基础武器伤害", "number"),
            ("weapon_speed", "武器速度", "number"),
            ("attack_speed_bonus", "攻速加成", "percent"),
            ("crit_chance", "暴击率", "percent"),
            ("critical_damage", "暴击伤害", "percent"),
            ("vulnerable_damage", "易伤伤害", "percent"),
            ("all_damage", "所有伤害", "percent"),
        ),
    ),
    (
        "伤害加成",
        (
            ("damage_bonuses.physical", "物理伤害", "percent"),
            ("damage_bonuses.fire", "火焰伤害", "percent"),
            ("damage_bonuses.lightning", "闪电伤害", "percent"),
            ("damage_bonuses.cold", "冰霜伤害", "percent"),
            ("damage_bonuses.holy", "神圣伤害", "percent"),
            ("damage_bonuses.poison", "毒素伤害", "percent"),
            ("damage_bonuses.shadow", "暗影伤害", "percent"),
            ("damage_bonuses.core", "核心伤害", "percent"),
            ("damage_bonuses.nature_magic", "自然魔法技能伤害", "percent"),
            ("damage_bonuses.storm", "风暴伤害", "percent"),
            ("damage_bonuses.werewolf", "狼人伤害", "percent"),
            ("damage_bonuses.close", "近距伤害", "percent"),
            ("damage_bonuses.distant", "远距伤害", "percent"),
            ("damage_bonuses.elite", "精英伤害", "percent"),
            ("damage_bonuses.crowd_controlled", "受控目标伤害", "percent"),
        ),
    ),
    (
        "防御",
        (
            ...
            ("potion_capacity", "药水数量", "number"),
            ("healing_received", "受到的治疗", "percent"),
            ("potion_healing", "药水治疗", "percent"),
            ("armor", "护甲", "number"),
            ("armor_damage_reduction", "护甲减伤", "percent"),
            ("armor_damage_reduction_cap", "护甲减伤上限", "percent"),
            ("barrier_bonus", "屏障加成", "percent"),
            ("dodge_chance", "躲闪几率", "percent"),
            ("pvp_damage_reduction", "PvP 伤害减免", "percent"),
        ),
    ),
    (
        "资源与通用",
        (
            ("max_resource", "灵力上限", "number"),
            ("spirit_regeneration", "灵力回复", "number"),
            ("resource_generation", "灵力生成", "percent"),
            ("movement_speed", "移动速度", "percent"),
            ("cooldown_reduction", "冷却缩减", "percent"),
            ("lucky_hit_chance_bonus", "幸运一击加成", "percent"),
            ("control_impairment_reduction", "限制减免", "percent"),
            ("experience_bonus", "经验值加成", "percent"),
        ),
    ),
    (
        "抗性评级",
        (
            ("resistance_ratings.physical", "物理抗性", "number"),
            ("resistance_ratings.fire", "火焰抗性", "number"),
            ("resistance_ratings.lightning", "闪电抗性", "number"),
            ("resistance_ratings.cold", "冰霜抗性", "number"),
            ("resistance_ratings.poison", "毒素抗性", "number"),
            ("resistance_ratings.shadow", "暗影抗性", "number"),
        ),
    ),
)
